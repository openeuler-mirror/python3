...
Patch323: backport-CVE-2021-23336.patch
...
* Mon Aug 30 2021 BruceGW<gyl93216@163.com> - 3.7.9-10
- Type:bugfix
- ID:NA
- SUG:NA
- DES:fix memory leak in socketserver.ThreadingMixIn

* Web Jun 23 2021 hanxinke<hanxinke@huawei.com> - 3.7.9-9
- Type:enhancement
- CVE:NA
- SUG:NA
...
* Web Mar 03 2021 wuchaochao<wuchaochao4@huawei.com> - 3.7.9-8
- Type:cves
- ID:CVE-2021-23336
- SUG:NA
- DESC:fix CVE-2021-23336

* Wed Feb 24 2021 hehuazhen<hehuazhen@huawei.com> - 3.7.9-7
- Type:bugfix
- ID:NA
- SUG:NA
...
* Sat Nov 14 2020 shixuantong<shixuantong@huawei.com> - 3.7.9-4
- Type:cves
- ID:CVE-2020-27619
- SUG:NA
- DESC:fix CVE-2020-27619

* Sat Oct 10 2020 tianwei<tianwei12@huawei.com> - 3.7.9-3
- Type:NA
- ID:NA
- SUG:NA
- DESC:modify patch
