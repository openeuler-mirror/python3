...
%changelog
* Tue Jul 30 2021 BruceGW<gyl93216@163.com> - 3.8.5-7
- Type:bugfix
- ID:NA
- SUG:NA
- DESC: fix memory leak in socketserver.ThreadingMixIn

* Web Mar 03 2021 wuchaochao<wuchaochao4@huawei.com> - 3.8.5-6
- Type:cves
- ID:CVE-2021-23336
- SUG:NA
- DESC: fix CVE-2021-23336

* Wed Feb 24 2021 hehuazhen<hehuazhen@huawei.com> - 3.8.5-5
- Type:bugfix
- ID:NA
- SUG:NA
